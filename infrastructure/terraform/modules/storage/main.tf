# Storage Module - S3 Buckets for Data Lake
# Creates S3 buckets with versioning, encryption, and lifecycle policies
...
resource "aws_s3_bucket" "data_lake" {
  ...
  tags = merge(
    var.tags,
    {
      ...
      Purpose = "Raw and processed financial data"
    }
  )
}
...
resource "aws_s3_bucket" "model_artifacts" {
  ...
  tags = merge(
    var.tags,
    {
      ...
      Purpose = "ML model weights and embeddings"
    }
  )
}
